...
export const intro = {
    ...
    현대 사회에서 웹만큼 접근하기 쉬운 플랫폼이 없고 모든 기업은 전문 웹 사이트를 가지고 있습니다.


    비즈니스에서 웹의 존재는 필수적인 것이 되었기 때문에, 웹 개발자는 어디에서나 필요한 존재가 되었습니다.


    더군다나 만드는 사람마다 다양하게 만들 수 있고 사용자에게 편의성을 제공할 수 있습니다.


    이런 점이 매력적이게 느껴져서 저는 프론트엔드 개발자가 되고 싶습니다.
    `,
};
